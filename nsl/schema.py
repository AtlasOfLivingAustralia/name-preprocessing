...
class NKChecklistSchema(Schema):
    id = fields.URL()
    taxonID = fields.URL()
    scientificNameID = fields.URL()
    acceptedNameUsageID = fields.URL()
    parentNameUsageID = fields.URL()
    originalNameUsageID = fields.URL()
    nameAccordingToID = fields.URL()
    namePublishedInID = fields.URL()
    taxonConceptID = fields.URL()
    ...
    family = fields.String(missing=None)
    subfamily = fields.String(missing=None)
    genus = fields.String(missing=None)
    genericName = fields.String(missing=None)
    subgenus = fields.String(missing=None)
    infragenericEpithet = fields.String(missing=None)
    specificEpithet = fields.String(missing=None)
    infraspecificEpithet  = fields.String(missing=None)
    taxonRank = fields.String(missing=None)
...
class CLBChecklistSchema(Schema):
    taxonID = fields.URL()
    parentNameUsageID = fields.URL()
    acceptedNameUsageID = fields.URL()
    originalNameUsageID = fields.URL()
    ...
    scientificName = fields.String(missing=None)
    scientificNameAuthorship = fields.String(missing=None)
    notho = fields.String(missing=None)
    genericName = fields.String(missing=None)
    infragenericEpithet = fields.String(missing=None)
    specificEpithet = fields.String(missing=None)
    infraspecificEpithet = fields.String(missing=None)
    ...
    family = fields.String(missing=None)
    subfamily = fields.String(missing=None)
    tribe = fields.String(missing=None)
    taxonRemarks = fields.String(missing=None)
